...
Slider.propTypes = {
  value: PropTypes.number, // Optional, the value of the slider
  defaultValue: PropTypes.number, // Optional, the default value of the slider
  marks: PropTypes.arrayOf(
    PropTypes.oneOfType([
      PropTypes.number, // Single number for mark
      PropTypes.shape({
        value: PropTypes.number.isRequired,
        label: PropTypes.string, // Optional label for mark
      }),
    ])
  ), // Optional, an array of marks with optional labels
  label: PropTypes.string, // Optional, label text for the slider
};
