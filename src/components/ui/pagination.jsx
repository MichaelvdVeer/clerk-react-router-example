...
PaginationRoot.propTypes = {
  size: PropTypes.oneOf(["sm", "md", "lg"]), // Validate size
  variant: PropTypes.oneOf(["outline", "solid", "subtle"]), // Validate variant
  getHref: PropTypes.func, // Validate getHref as a function
};
...
PaginationItem.propTypes = {
  value: PropTypes.number.isRequired, // Ensure value is a number
...
export const PaginationPageText = forwardRef(function PaginationPageText(
  props,
  ref
) {
...
PaginationPageText.propTypes = {
  format: PropTypes.oneOf(["short", "compact", "full"]),
};
